...
%1 displays curvature vectors on the outside of the aerofoil if concave and on the inside if convex
...
curvature_vectors_bot = curv_tog*curvature_vectors_bot/curvature_scale;
